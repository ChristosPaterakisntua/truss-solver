...
class TrussSolverConan(ConanFile):
    ...
    settings = "os", "arch", "compiler", "build_type", "compiler.cppstd"
    ...
    exports_sources = "CMakeLists.txt", "cmake/*", "solver/*", "LICENSE"
    ...
    def build(self):
        cmake = CMake(self)
        # Keep the packaged artifact self-contained and easy to consume.
        cmake.configure(cli_args=["-DBUILD_SHARED_LIBS=OFF"])
        cmake.build()
